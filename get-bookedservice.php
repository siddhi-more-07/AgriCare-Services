...
<body>
    ...
    $query = "SELECT product_name, quantity, contact_no FROM booked_orders WHERE email = '$checkforemail'";
    ...
    if ($result->num_rows > 0) {
        // Output table header
        echo "<table>";
        echo "<tr><th>Product Name</th><th>Quantity</th><th>Contact Number</th></tr>";
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            // Echo table row
            echo "<tr><td>$productName</td><td>$quantity</td><td>$contactNo</td></tr>";
        }
